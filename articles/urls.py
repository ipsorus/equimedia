...
urlpatterns = [
    ...
    path('articles/<int:pk>/update/', ArticlePostUpdateView.as_view(), name='article_post_update'),
    path('articles/<int:pk>/delete/', ArticlePostDeleteView.as_view(), name='article_post_delete'),
]